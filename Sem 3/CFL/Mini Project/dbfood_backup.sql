...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 30, 2022 at 08:06 PM
...
CREATE TABLE `tbadmin` (
  `fld_id` int(10) NOT NULL DEFAULT 0,
  `fld_username` varchar(30) CHARACTER SET latin1 NOT NULL,
  `fld_password` varchar(30) CHARACTER SET latin1 NOT NULL
...
CREATE TABLE `tbfood` (
  ...
  `cuisines` varchar(50) CHARACTER SET utf8 NOT NULL,
  `paymentmode` varchar(50) CHARACTER SET utf8 NOT NULL,
  `fldimage` varchar(1000) CHARACTER SET utf8 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tblcart` (
  `fld_cart_id` int(11) NOT NULL DEFAULT 0,
  `fld_product_id` bigint(11) NOT NULL,
  `fld_customer_id` varchar(50) CHARACTER SET utf8 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tblcustomer` (
  `fld_cust_id` int(10) NOT NULL DEFAULT 0,
  `fld_name` varchar(30) CHARACTER SET utf8 NOT NULL,
  `fld_email` varchar(30) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE `tblmessage` (
  `fld_msg_id` int(10) NOT NULL DEFAULT 0,
  `fld_name` varchar(50) CHARACTER SET utf8 NOT NULL,
  `fld_email` varchar(50) CHARACTER SET utf8 NOT NULL,
  `fld_phone` bigint(10) DEFAULT NULL,
  `fld_msg` varchar(200) CHARACTER SET utf8 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tblorder` (
  `fld_order_id` int(10) NOT NULL DEFAULT 0,
  `fld_cart_id` bigint(10) NOT NULL,
  `fldvendor_id` bigint(10) DEFAULT NULL,
  `fld_food_id` bigint(10) DEFAULT NULL,
  `fld_email_id` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
  `fld_payment` varchar(20) CHARACTER SET utf8 DEFAULT NULL,
  `fldstatus` varchar(20) CHARACTER SET utf8 DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `tblvendor` (
  `fldvendor_id` int(10) NOT NULL DEFAULT 0,
  `fld_name` varchar(30) CHARACTER SET latin1 NOT NULL,
  `fld_email` varchar(50) CHARACTER SET latin1 NOT NULL,
  `fld_password` varchar(50) CHARACTER SET latin1 NOT NULL,
  `fld_mob` bigint(10) NOT NULL,
  `fld_phone` bigint(10) NOT NULL,
  `fld_address` varchar(50) CHARACTER SET latin1 NOT NULL,
  `fld_logo` varchar(250) CHARACTER SET latin1 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
